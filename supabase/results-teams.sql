...
values ('a0000000-0000-0000-0000-0000000000cs','KWANSIRI CS','กรุงเทพมหานคร','ยามาล','โค้ชนก','โค้ชโรตี')
on conflict (id) do nothing;

insert into players (team_id, name, number, position, sort) values
  ('a0000000-0000-0000-0000-0000000000cs','เมือง วรวิทย์',1,'GK',1),
  ('a0000000-0000-0000-0000-0000000000cs','แจ่น ธรรมรัตน์',4,'DF',2),
  ('a0000000-0000-0000-0000-0000000000cs','ขัย พรชัย',5,'DF',3),
  ('a0000000-0000-0000-0000-0000000000cs','ปู มนัสชัย',6,'DF',4),
  ('a0000000-0000-0000-0000-0000000000cs','เปตอง ณัฏฐิกรณ์',3,'DF',5),
  ('a0000000-0000-0000-0000-0000000000cs','นาย ศิลา',8,'MF',6),
  ('a0000000-0000-0000-0000-0000000000cs','อ๊อฟ สุรวุฒิ',10,'MF',7),
  ('a0000000-0000-0000-0000-0000000000cs','เต๋ย อัครพล',7,'MF',8),
  ('a0000000-0000-0000-0000-0000000000cs','เบนซ์ กฤษณะ',11,'MF',9),
  ('a0000000-0000-0000-0000-0000000000cs','กาย พงศธร',14,'FW',10),
  ('a0000000-0000-0000-0000-0000000000cs','โฟริว ยุธธกร',9,'FW',11),
  ('a0000000-0000-0000-0000-0000000000cs','ต๊าร์ หฤษฏิ์',17,'MF',12),
  ('a0000000-0000-0000-0000-0000000000cs','อาแปะ นพรัตน์',20,'DF',13),
  ('a0000000-0000-0000-0000-0000000000cs','พี พีรวิชญ์',13,'FW',14),
  ('a0000000-0000-0000-0000-0000000000cs','ฟีฟ่า ภูริณัฐ',19,'FW',15)
